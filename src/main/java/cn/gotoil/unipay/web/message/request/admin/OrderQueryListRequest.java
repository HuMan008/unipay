...
public class OrderQueryListRequest extends BasePageRequest {
    // 查询参数
    @ApiModelProperty(required = false, example = "{\"appid\":\"AQhPkDihNxljLFpsBUdelgIP\",\"queryId\":\"201910110950394386590\",\"status\":\"0\",\"payType\":\"AlipayH5\"}", value = "查询条件Key为[appid:应用id," +
